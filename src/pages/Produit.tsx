...
const VARIANTS: Record<string, { name: string; main: string; top: string; bottom: string }> = {
  olive: { name: 'Olive', main: '/images/olive/Adobe Express - file (2).png', top: '/images/olive/baton.png', bottom: '/images/olive/man.png' },
  gold: { name: 'Lavande', main: '/images/lavande/Adobe Express - file (1).png', top: '/images/lavande/Component.png', bottom: '/images/lavande/photoshopempastick.png' },
  neutral: { name: 'Flamme', main: '/images/rouge/Adobe Express - file.png', top: '/images/rouge/Component.png', bottom: '/images/rouge/womenbancrouge.png' },
}
